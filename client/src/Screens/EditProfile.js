    ...
    class EditProfile extends React.Component {
        ...
        constructor(props) {
          ...
          this.state = {
            ...
            input: {
              ...
              activityLevel: params.pet.activityLevel,
              picKey: '',
            },
            showActivityIndicator: false,
          }
          if (params.pet.activityLevel === 'Sedentary'){
           this.state.value2Index = 0;
          } else if (params.pet.activityLevel === 'LightlyActive') {
          this.state.value2Index = 1;
          } else if (params.pet.activityLevel === 'Active') {
          this.state.value2Index = 2;
          } else {
          this.state.value2Index = 3;
          }
          if (params.pet.picKey){
            this.state.input.picKey = params.pet.picKey;
          } else {
            this.state.input.picKey = 'useIcon';
          }
      ...
      EditProfile = () => {
        ...
        if (this.state.selectedImageIndex === null){
          this.handleUpdatePet(this.props.navigation.state.params.pet.petId, petInfo);
        } else {
          ...
          this.readImage(imageNode)
            ...
            .then(this.handleUpdatePet.bind(this, this.props.navigation.state.params.pet.petId))
            .then(data => {
      ...
      async handleUpdatePet(petId, pet) {
        console.log(JSON.stringify(petId));
        console.log(JSON.stringify(pet));

        const updateParams = pet;
                  ...
                  selectedImageIndex === null ? (
                    this.state.input.picKey === 'useIcon' ? (
                      ...
                      <Image
                        ...
                        source={{ uri: Storage.getObjectUrl(this.state.input.picKey) }}
                      />
                    )
                  ) : (
                      <Image
